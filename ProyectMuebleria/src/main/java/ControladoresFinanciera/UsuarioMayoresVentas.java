 ...
 * @author joel
 */
@WebServlet(name = "UsuarioMayoresVentas", urlPatterns = {"/UsuarioMayoresVentas"})
public class UsuarioMayoresVentas extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String nombreUsuario = modeloUsuario.nombreUsuarioMayorRepeticion();
        ArrayList<EntidadVentas> ventasUsuario = modeloUsuario.ventasUsuarioMayorVentas(nombreUsuario);
        request.setAttribute("ventas", ventasUsuario);

        request.getRequestDispatcher("AreaFinanciera/UsuarioMayorVentas.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if ((fecha1.isEmpty() && !fecha2.isEmpty() || (!fecha1.isEmpty() && fecha2.isEmpty()))) {
            ...
            if (fecha1.isEmpty() && fecha2.isEmpty()) { //Sin parametros de fecha especificados
                nombreUsuario = modeloUsuario.nombreUsuarioMayorRepeticion();
                listVentas = modeloUsuario.ventasUsuarioMayorVentas(nombreUsuario);
            } else {
                ...
                try {
                    ...
                    if (date1.isAfter(date2)) {
                        ...
                        nombreUsuario = modeloUsuario.nombreUsuarioMayorRepeticionIntervalo(date1, date2);
                        listVentas = modeloUsuario.ventasUsuarioMayorVentasIntervalo(nombreUsuario, date1, date2);
                    }
