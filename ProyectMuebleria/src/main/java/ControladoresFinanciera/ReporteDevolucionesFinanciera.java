 ...
 * @author joel
 */
@WebServlet(name = "ReporteDevolucionesFinanciera", urlPatterns = {"/ReporteDevolucionesFinanciera"})
public class ReporteDevolucionesFinanciera extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<EntidadDevolucion> listaDevoluciones = modeloReporte.getDevoluciones();
        request.setAttribute("devoluciones", listaDevoluciones);

        request.getRequestDispatcher("AreaFinanciera/ReporteDevoluciones.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        LocalDate date1;
        LocalDate date2;
        ArrayList<EntidadDevolucion> listaDevoluciones = null;
        ...
        if ((fecha1.isEmpty() && !fecha2.isEmpty() || (!fecha1.isEmpty() && fecha2.isEmpty()))) {
            ...
            if (fecha1.isEmpty() && fecha2.isEmpty()) { //Sin parametros de fecha especificados
                listaDevoluciones = modeloReporte.getDevoluciones();
            } else {
                ...
                try {
                    ...
                    if (date1.isAfter(date2)) {
                        ...
                        listaDevoluciones = modeloReporte.getDevolucionesFilter(date1, date2);
                    }
