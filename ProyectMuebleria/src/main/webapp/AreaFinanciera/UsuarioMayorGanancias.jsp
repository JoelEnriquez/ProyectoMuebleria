...
<html>
    <head>
        ...
        <title>Usuario Mayor Registro de Ganancias</title>
            ...
            <div class="row justify-content-around mt-5">
                        ...
                        <table class="table table-striped table-bordered mt-5" id="tabla_exportar">
                            <thead class="table-dark">
                                <tr>
                                    ...
                                    <th class="th-sm">Ganancias de Producto</th>
                            ...
                            <tbody id="tablaFiltro">
                                <c:forEach items="${listaGanancias}" var="listaGanancia">
                                    <tr>
                                        ...
                                        <td class="bg-primary text-dark">${listaGanancia.ingresoTotal}</td>
                                        <td class="bg-primary text-dark">${listaGanancia.gananciaTotal}</td>
                                        <td class="bg-success text-dark">${listaGanancia.nombreUsuario}</td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                            <tfoot>
                ...
                <div class="col-3 align-self-center">
                    <div class="row">
                        ...
                        <form action="${pageContext.request.contextPath}/UsuarioMayoresGanancias" method="POST">
                            <h3>Usuario Mayores Ganancias por Intervalo</h3>
