            ...
            <div class="row justify-content-around mt-5">
                        ...
                        <table class="table table-striped table-bordered mt-5" id="tabla_exportar">
                            <thead class="table-dark">
                                <tr>
                                    ...
                                    <th class="th-sm">Fecha de Devolucion</th>
                                    <th class="th-sm">Perdidas</th>
                                </tr>
                            </thead>
                            <tbody id="tablaFiltro">
                                <c:forEach items="${devoluciones}" var="devolucion">
                                    <tr>
                                        ...
                                        <td>${devolucion.precioUnitario}</td>
                                        <td>${devolucion.fechaDevolucion}</td>
                                        <td>${devolucion.perdidas}</td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                            <tfoot>
                ...
                <div class="col-3 align-self-center">
                    <div class="row">
                        ...
                        <form action="${pageContext.request.contextPath}/ReporteDevolucionesFinanciera" method="POST">
                            <h3>Devoluciones por Intervalo</h3>
